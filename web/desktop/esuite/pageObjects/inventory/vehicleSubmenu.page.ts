...
export class VehicleSubmenuPage {
  readonly page: Page;
  readonly headerComponent: HeaderComponent;

  readonly titleVehicle: Locator;
  ...
  constructor(page: Page) {
    ...
    this.titleVehicle = page.locator("main>header>div:nth-child(1)>h2");
  ...
  async screenshotListPage() {
    ...
    await expect(this.page).toHaveScreenshot("listVehicle.png", {
    ...
    const actualText = await this.titleVehicle.textContent();
    await expect(actualText).toMatchSnapshot("titleVehicle.txt");
  }
}
