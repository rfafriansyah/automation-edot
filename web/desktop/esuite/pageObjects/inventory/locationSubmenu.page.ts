...
export class LocationSubmenuPage {
  readonly page: Page;
  readonly headerComponent: HeaderComponent;

  readonly titleLocation: Locator;
  ...
  constructor(page: Page) {
    ...
    this.titleLocation = page.locator("main>header>div:nth-child(1)>h2");
  ...
  async screenshotListPage() {
    ...
    await expect(this.page).toHaveScreenshot("listLocation.png", {
    ...
    const actualText = await this.titleLocation.textContent();
    await expect(actualText).toMatchSnapshot("titleLocation.txt");
  }
}
