...
export class CanvassBookingSubmenuPage {
  readonly page: Page;
  readonly headerComponent: HeaderComponent;

  readonly titleCanvassBooking: Locator;
  ...
  constructor(page: Page) {
    ...
    this.titleCanvassBooking = page.locator("main>header>div:nth-child(1)>h2");
  ...
  async screenshotListPage() {
    ...
    await expect(this.page).toHaveScreenshot("listCanvassBooking.png", {
    ...
    const actualText = await this.titleCanvassBooking.textContent();
    await expect(actualText).toMatchSnapshot("titleCanvassBooking.txt");
  }
}
