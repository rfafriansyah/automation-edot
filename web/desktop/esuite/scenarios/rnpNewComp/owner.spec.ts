import { ownerNew } from "../../../../../helper/esuite/credentials";
import { test } from "../../pageObjects/Base.page";

test.describe("RnP Esuite", () => {
  test.beforeEach(async ({ page, loginPage, eworkPage }) => {
    await loginPage.open();
    await loginPage.filltxtCompanyID(ownerNew.companyId);
    await loginPage.filltxtEmployeeIDUsername(ownerNew.username);
    await loginPage.filltxtPassword(ownerNew.password);
