import { esuiteAdminNonHQNew } from "../../../../../helper/esuite/credentials";
import { test } from "../../pageObjects/Base.page";

test.describe("RnP Esuite", () => {
  test.beforeEach(async ({ page, loginPage, eworkPage }) => {
    await loginPage.open();
    await loginPage.filltxtCompanyID(esuiteAdminNonHQNew.companyId);
    await loginPage.filltxtEmployeeIDUsername(esuiteAdminNonHQNew.username);
    await loginPage.filltxtPassword(esuiteAdminNonHQNew.password);
