import { esuiteAdminHQExisting } from "../../../../../helper/esuite/credentials";
import { test } from "../../pageObjects/Base.page";

test.describe("RnP Esuite", () => {
  test.beforeEach(async ({ page, loginPage, eworkPage }) => {
    await loginPage.open();
    await loginPage.filltxtCompanyID(esuiteAdminHQExisting.companyId);
    await loginPage.filltxtEmployeeIDUsername(esuiteAdminHQExisting.username);
    await loginPage.filltxtPassword(esuiteAdminHQExisting.password);
