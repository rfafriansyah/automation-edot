...
import { payloadLogin, payloadCreateIndonesia, payloadGeneralInfo } from '../../../../helper/payloadHermes'

test.describe.serial("Create Company User on Hermes - Positive", () => {
  test.beforeEach(async ({ page, loginPage, navbarPage, companiesPage, registerCompanyPage }) => {
