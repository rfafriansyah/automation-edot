...
export class RegisterCompanyPage {
  ...
  constructor(page: Page) {
    ...
    this.drpdwnIndustryType = page.getByRole('combobox').filter({ hasText: 'Choose Industry Type' })
    this.drpdwnCompanyType = page.getByRole('combobox').filter({ hasText: 'Choose Company Type' })
    this.drpdwnLanguage = page.getByRole('combobox').filter({ hasText: 'Choose Language' })
    ...
    // Country: Malaysia
    this.drpdwnState = page.getByRole('combobox').filter({ hasText: 'Choose State' })
    this.drpdwnLocation = page.getByRole('combobox').filter({ hasText: 'Choose Location' })
    this.drpdwnPostalCode = page.getByRole('combobox').filter({ hasText: 'Choose Postal Code' })
    // Country: Philippine
    this.drpdwnRegion = page.getByRole('combobox').filter({ hasText: 'Choose Region' })
    this.drpdwnBarangay = page.getByRole('combobox').filter({ hasText: 'Choose Barangay' })
